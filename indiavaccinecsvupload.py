...
def preprocess_func():
    data = pd.read_csv('/mnt/c/DAG/covid_vaccine_statewise.csv')
    ...
    data.to_csv("/mnt/c/DAG/processed_india_covid_vaccination.csv", index=None)
...
def carga_stage(conn, **kwargs):
    ...
    csv_file='/mnt/c/DAG/processed_india_covid_vaccination.csv'
